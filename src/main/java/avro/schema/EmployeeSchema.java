...
public class EmployeeSchema extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static avro.schema.EmployeeSchema.Builder newBuilder() {
    return new avro.schema.EmployeeSchema.Builder();
  }
  
  /** Creates a new EmployeeSchema RecordBuilder by copying an existing Builder */
  public static avro.schema.EmployeeSchema.Builder newBuilder(avro.schema.EmployeeSchema.Builder other) {
    return new avro.schema.EmployeeSchema.Builder(other);
  }
  
  /** Creates a new EmployeeSchema RecordBuilder by copying an existing EmployeeSchema instance */
  public static avro.schema.EmployeeSchema.Builder newBuilder(avro.schema.EmployeeSchema other) {
    return new avro.schema.EmployeeSchema.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EmployeeSchema>
    ...
    private Builder() {
      super(avro.schema.EmployeeSchema.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.schema.EmployeeSchema.Builder other) {
      super(other);
    ...
    private Builder(avro.schema.EmployeeSchema other) {
            super(avro.schema.EmployeeSchema.SCHEMA$);
      if (isValidValue(fields()[0], other.Id)) {
        this.Id = data().deepCopy(fields()[0].schema(), other.Id);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'Id' field */
    public avro.schema.EmployeeSchema.Builder setId(long value) {
    ...
    public avro.schema.EmployeeSchema.Builder clearId() {
    ...
    /** Sets the value of the 'firstName' field */
    public avro.schema.EmployeeSchema.Builder setFirstName(java.lang.CharSequence value) {
    ...
    public avro.schema.EmployeeSchema.Builder clearFirstName() {
      firstName = null;
    ...
    /** Sets the value of the 'lastName' field */
    public avro.schema.EmployeeSchema.Builder setLastName(java.lang.CharSequence value) {
    ...
    public avro.schema.EmployeeSchema.Builder clearLastName() {
      lastName = null;
    ...
    /** Sets the value of the 'title' field */
    public avro.schema.EmployeeSchema.Builder setTitle(java.lang.CharSequence value) {
    ...
    public avro.schema.EmployeeSchema.Builder clearTitle() {
      title = null;
    ...
    /** Sets the value of the 'createdDate' field */
    public avro.schema.EmployeeSchema.Builder setCreatedDate(java.lang.CharSequence value) {
    ...
    public avro.schema.EmployeeSchema.Builder clearCreatedDate() {
      createdDate = null;
    ...
    /** Sets the value of the 'modifiedDate' field */
    public avro.schema.EmployeeSchema.Builder setModifiedDate(java.lang.CharSequence value) {
    ...
    public avro.schema.EmployeeSchema.Builder clearModifiedDate() {
      modifiedDate = null;
